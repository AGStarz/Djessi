...
extension ReactiveExtension where Source: UICollectionViewLayoutAttributes {
    ...
    public var zIndex: AnyKeyPathObservable<Source, Int> {
    ...
    public var indexPath: AnyKeyPathObservable<Source, IndexPath> {
