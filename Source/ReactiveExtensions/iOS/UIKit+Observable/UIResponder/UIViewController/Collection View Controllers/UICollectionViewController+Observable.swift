...
extension ReactiveExtension where Source: UICollectionViewController {
    ...
    public var collectionView: KeyPathObservable<Source, UICollectionView?> {
    ...
    @available(iOS 7.0, *)
    public var useLayoutToLayoutNavigationTransitions: KeyPathObservable<Source, Bool> {
    ...
    @available(iOS 9.0, *)
    public var installsStandardGestureForInteractiveMovement: KeyPathObservable<Source, Bool> {
